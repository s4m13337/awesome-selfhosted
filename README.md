...
- [Peppermint](https://peppermint.sh/) - Peppermint is a fully open source helpdesk solution. ([Source Code](https://github.com/Peppermint-Lab/peppermint)) `GPL-3.0` `Docker`
